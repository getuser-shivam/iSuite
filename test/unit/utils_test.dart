...
void main() {
  group('AppUtils Tests', () {
    ...
    group('String Utilities', () {
      ...
      test('removeHtml should strip HTML tags', () {
        final result = AppUtils.removeHtml('<p>Hello <b>World</b></p>');
        expect(result, equals('Hello World'));
      });
    });
    ...
    group('Color Utilities', () {
      ...
      test('getContrastColor should return appropriate contrast color', () {
        final lightColor = const Color(0xFFFFFF);
        final darkColor = const Color(0x000000);

  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        body: Consumer<ThemeProvider>(
          builder: (context, themeProvider, child) => SingleChildScrollView(
            padding: EdgeInsets.all(_config.getParameter('ui.default_padding',
                defaultValue: AppConstants.DEFAULT_PADDING.toDouble())),
            child: Column(
              ...
              children: [
                Text(
                  'Theme Mode',
                  style: TextStyle(
                      fontSize: _config.getParameter('ui.theme_title_font_size',
                          defaultValue: AppConstants.THEME_TITLE_FONT_SIZE),
                      fontWeight: FontWeight.bold),
                ),
                SizedBox(
                    height: _config.getParameter('ui.default_spacing',
                        defaultValue: AppConstants.DEFAULT_SPACING.toDouble())),
                _buildThemeModeSelector(themeProvider),
                SizedBox(
                    height: _config.getParameter('ui.large_spacing',
                        defaultValue: AppConstants.LARGE_SPACING.toDouble())),
                Text(
                  'Preset Themes',
                  style: TextStyle(
                      fontSize: _config.getParameter('ui.theme_title_font_size',
  ...
  Widget _buildPresetThemes(ThemeProvider themeProvider) {
    ...
    return GridView.builder(
      ...
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
        crossAxisCount: _config.getParameter('ui.theme_grid_cross_axis_count',
            defaultValue: AppConstants.THEME_GRID_CROSS_AXIS_COUNT),
        crossAxisSpacing: _config.getParameter('ui.default_spacing',
            defaultValue: AppConstants.DEFAULT_SPACING.toDouble()),
        mainAxisSpacing: _config.getParameter('ui.default_spacing',
            defaultValue: AppConstants.DEFAULT_SPACING.toDouble()),
        childAspectRatio: _config.getParameter('ui.theme_grid_aspect_ratio',
            defaultValue: AppConstants.THEME_GRID_ASPECT_RATIO),
      ),
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(_config.getParameter(
                  'ui.card_radius',
                  defaultValue: AppConstants.CARD_RADIUS.toDouble())),
              border: Border.all(
            ...
            child: Stack(
              children: [
                ...
                Positioned(
                  ...
                  right: 8,
                  child: Container(
                    width: _config.getParameter('ui.theme_color_indicator_size',
                        defaultValue: AppConstants.THEME_COLOR_INDICATOR_SIZE),
                    height: _config.getParameter(
                        'ui.theme_color_indicator_size',
                        defaultValue: AppConstants.THEME_COLOR_INDICATOR_SIZE),
                    decoration: BoxDecoration(
                ...
                if (isSelected)
                  const Positioned(
                    ...
                    child: Icon(
                      Icons.check_circle,
                      color: Colors.white,
                      size: _config.getParameter('ui.theme_preview_icon_size',
                          defaultValue: AppConstants.THEME_PREVIEW_ICON_SIZE),
                    ),
                  ),
              ],
            ),
  ...
  Widget _buildColorSelector(
    ...
    return Column(
      ...
      children: [
        Text(label),
        SizedBox(
            height: _config.getParameter('ui.small_spacing',
                defaultValue: AppConstants.SMALL_SPACING.toDouble())),
        Wrap(
          spacing: 8,
          runSpacing: 8,
          children: presetColors.map((color) {
            ...
            return GestureDetector(
              ...
              child: Container(
                width: _config.getParameter('ui.color_selector_size',
                    defaultValue: AppConstants.COLOR_SELECTOR_SIZE),
                height: _config.getParameter('ui.color_selector_size',
                    defaultValue: AppConstants.COLOR_SELECTOR_SIZE),
                decoration: BoxDecoration(
                  color: color,
                  shape: BoxShape.circle,
                ...
                child: isSelected
                    ? const Icon(
                        Icons.check,
                        color: Colors.white,
                        size: _config.getParameter('ui.small_icon_size',
                            defaultValue:
                                AppConstants.SMALL_ICON_SIZE.toDouble()),
                      )
                    : null,
              ),
            );
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              // Sample app bar
              Container(
                height: _config.getParameter('ui.theme_preview_height',
                    defaultValue: AppConstants.THEME_PREVIEW_HEIGHT),
                color: themeProvider.currentTheme.primaryColor,
                alignment: Alignment.centerLeft,
                padding: EdgeInsets.symmetric(
                  horizontal: _config.getParameter('ui.default_padding',
                      defaultValue: AppConstants.DEFAULT_PADDING.toDouble()),
                ),
                child: Text(
                  'Theme Mode',
                  style: TextStyle(
                    fontSize: _config.getParameter('ui.font_size_medium',
                        defaultValue: AppConstants.FONT_SIZE_MEDIUM.toDouble()),
              ...
              // Sample card
              Container(
                padding: EdgeInsets.all(_config.getParameter(
                    'ui.default_padding',
                    defaultValue: AppConstants.DEFAULT_PADDING.toDouble())),
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(_config.getParameter(
                      'ui.button_radius',
                      defaultValue: AppConstants.BUTTON_RADIUS.toDouble())),
                  border: Border.all(
                      color: themeProvider.currentTheme.primaryColor
                          .withOpacity(0.3)),
                ),
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                        height: _config.getParameter('ui.small_spacing',
                            defaultValue:
                                AppConstants.SMALL_SPACING.toDouble())),
                    Text(
                    ...
                    SizedBox(
                        height: _config.getParameter('ui.default_spacing',
                            defaultValue:
                                AppConstants.DEFAULT_SPACING.toDouble())),
                    Row(
                      children: [
                        ElevatedButton(
                          onPressed: () {},
                        ...
                        SizedBox(
                            width: _config.getParameter('ui.small_spacing',
                                defaultValue:
                                    AppConstants.SMALL_SPACING.toDouble())),
                        OutlinedButton(
                          onPressed: () {},

...
class LoadingIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final indicatorSize =
        size ?? configToUse.getParameter('ui.icon_size_lg', defaultValue: 32.0);
    final textSize =
        configToUse.getParameter('ui.font_size_md', defaultValue: 16.0);
    final textWeight = FontWeight.values[
        configToUse.getParameter('ui.font_weight_medium', defaultValue: 500)];

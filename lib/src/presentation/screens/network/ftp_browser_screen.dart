...
import '../../providers/network/ftp_provider.dart';
...
class _FtpBrowserScreenState extends ConsumerState<FtpBrowserScreen> {
  ...
  Widget _buildFileBrowser(FtpState ftpState, FtpStateNotifier ftpNotifier, bool isDesktop) {
  ...
  IconData _getFileIcon(FtpFile file) {
    ...
    if (['txt', 'md', 'doc', 'docx'].contains(ext)) return Icons.text_snippet;

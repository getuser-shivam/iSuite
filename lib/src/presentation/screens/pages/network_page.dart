...
class _NetworkPageState extends State<NetworkPage>
  ...
  void initState() {
    super.initState();
    _tabController =
        TabController(length: 5, vsync: this); // Increased to 5 tabs
                  ...
                  child: Card(
                    ...
                    child: ExpansionTile(
                      leading: CircleAvatar(
                        backgroundColor:
                            _getDeviceColor(device['type']).withOpacity(0.2),
                        child: Icon(
                      ...
                      trailing: Row(
                        ...
                        children: [
                          ...
                          PopupMenuButton<String>(
                            onSelected: (action) =>
                                _handleDeviceAction(action, device),
                            itemBuilder: (context) => [
                              const PopupMenuItem(
                                value: 'connect',
                                child: ListTile(
                          ...
                          child: Column(
                            ...
                            children: [
                              Wrap(
                                spacing: 8,
                                runSpacing: 8,
                                children: (device['services'] as List<dynamic>)
                                    .map((service) {
                                  return Chip(
                                    label: Text(service,
                  ...
                  child: Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          Text(
                              '${folder['server']} • ${folder['files']} files'),
                          Text(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle:
                          Text('${stream['client']} • ${stream['speed']}'),
                      trailing: Text(
  ...
  Widget _buildStreamingStat(BuildContext context, String title, String value,
      IconData icon, Color color) {
    return GradientCard(
      gradient: LinearGradient(
        colors: [
  ...
  Widget _buildProtocolChip(
      BuildContext context, String protocol, Color color) {
    return Chip(
      label: Text(
        protocol,
        style: TextStyle(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            if (device['os'] != null) Text('Operating System: ${device['os']}'),
          ],
        ),
        actions: [
          TextButton(

                    ...
                    children: [
                      ...
                      GridView.builder(
                        ...
                        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                          ...
                          crossAxisSpacing:
                              themeProvider.uiGridCrossAxisSpacing,
                          mainAxisSpacing: themeProvider.uiGridMainAxisSpacing,
                          childAspectRatio:
                              themeProvider.uiGridChildAspectRatio,
                        ),
                        ...
                        itemBuilder: (context, index) {
                          return SlideInAnimation(
                            ...
                            delay: Duration(
                                milliseconds: themeProvider
                                        .uiAnimationDelayXLong.inMilliseconds +
                                    (index * 100)),
                            child: ScaleAnimation(
                              delay: Duration(
                                  milliseconds: themeProvider
                                          .uiAnimationDelayXLong
                                          .inMilliseconds +
                                      (index * 100) +
                                      100),
                              child:
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(
                        themeProvider.uiBorderRadiusMedium),
                  ),
                  child: Icon(icon,
                      color: color, size: themeProvider.uiIconSizeMedium),
                ),
                const Spacer(),
                Text(
                  trend,
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: (feature['color'] as Color)
                        .withOpacity(themeProvider.uiOpacityMedium),
                    borderRadius: BorderRadius.circular(
                        themeProvider.uiBorderRadiusLarge),
                  ),
                  child: Icon(
                    feature['icon'],
                    color: feature['color'],
    ...
    final activities = [
      {
        ...
        'color': themeProvider.uiCardSuccessColor
      },
      {
        'title': 'Network scan',
        'subtitle': '3 devices found',
        'time': '5m ago',
        'icon': Icons.wifi_find,
        'color': themeProvider.uiCardInfoColor
      },
      {
        'title': 'Backup created',
        'subtitle': 'backup_2024.zip',
        'time': '1h ago',
        'icon': Icons.backup,
        'color': themeProvider.uiCardWarningColor
      },
      {
        ...
        'time': '2h ago',
        'icon': Icons.settings,
        'color': themeProvider.uiCardSecondaryColor
      },
    ];
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return SlideInAnimation(
          direction: SlideDirection.fromLeft,
          delay: Duration(
              milliseconds: themeProvider.uiAnimationDelayXLong.inMilliseconds +
                  1000 +
                  (index * 100)),
          child: Card(
            ...
            shape: RoundedRectangleBorder(
              borderRadius:
                  BorderRadius.circular(themeProvider.uiBorderRadiusMedium),
            ),
            child: ListTile(
              leading: Container(
                padding: EdgeInsets.all(themeProvider.uiPaddingSmall),
                decoration: BoxDecoration(
                  color: (activity['color'] as Color)
                      .withOpacity(themeProvider.uiOpacityLow),
                  borderRadius:
                      BorderRadius.circular(themeProvider.uiBorderRadiusSmall),
                ),
                child: Icon(
                  activity['icon'],
      ...
      builder: (context) => Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.vertical(
              top: Radius.circular(themeProvider.uiBorderRadiusLarge)),
        ),
        child: Column(
          children: [
            Container(
              ...
              margin:
                  EdgeInsets.symmetric(vertical: themeProvider.uiMarginMedium),
              decoration: BoxDecoration(
                color: Theme.of(context)
                    .colorScheme
                    .onSurfaceVariant
                        ...
                        children: [
                          Icon(
                            ...
                            color: Theme.of(context)
                                .colorScheme
                                .onSurfaceVariant
                                .withOpacity(themeProvider.uiOpacityHigh),
                          ),
                          SizedBox(height: themeProvider.uiMarginMedium),
                          Text(
                            'No notifications',
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        margin: EdgeInsets.only(
                            bottom: themeProvider.uiMarginSmall),
                        elevation: themeProvider.uiElevationLow,
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(
                              themeProvider.uiBorderRadiusMedium),
                        ...
                        child: ListTile(
                          ...
                          trailing: IconButton(
                            icon: Icon(Icons.close,
                                size: themeProvider.uiIconSizeSmall),
                            onPressed: () =>
                                appProvider.removeNotification(notification.id),
                          ),
                        ),
                      );
                    },
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius:
              BorderRadius.circular(themeProvider.uiBorderRadiusLarge),
          border: Border.all(
  ...
  void _showSystemInfo(BuildContext context) {
    showAboutDialog(
      ...
      children: [
        ...
        const Text(
            'Advanced animations, real-time monitoring, enterprise features'),
      ],
    );
  }
    ...
    return [
      {
        ...
        'subtitle': 'Found in Files - 247 items',
        'icon': Icons.folder,
        'color': Colors.blue,
        'route': '/files'
      },
      {
        'title': 'WiFi Settings',
        'subtitle': 'Found in Network Settings',
        'icon': Icons.wifi,
        'color': Colors.green,
        'route': '/network'
      },

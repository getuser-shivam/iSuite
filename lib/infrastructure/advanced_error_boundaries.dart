  ...
  Widget build(BuildContext context) {
    if (_hasError && _currentError != null) {
      if (widget.fallbackBuilder != null) {
        return widget.fallbackBuilder!(context, _currentError!.error, _currentError!.stackTrace);
      }
...
class NetworkErrorBoundary extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<NetworkErrorBoundary> createState() => _NetworkErrorBoundaryState();
}

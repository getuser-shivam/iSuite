...
class _VoiceRecorderWidgetState extends State<VoiceRecorderWidget>
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: widget.isRecording
              ...
              : _config.getParameter('ui.colors.outline',
  ...
  Widget _buildWaveformVisualization() {
    return Container(
      height: _config.getParameter('ui.voice_recorder.waveform_height',
          defaultValue: 60.0),
      ...
      builder: (context, child) {
        return Row(
          ...
          children: List.generate(20, (index) {
            ...
            return Container(
              width: _config.getParameter('ui.voice_recorder.bar_width',
                  defaultValue: 3.0),
              height: height,
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(_config
                    .getParameter('ui.border_radius.small', defaultValue: 2.0)),
              ),
            );
          }),
        );
      ...
      builder: (context, child) {
        return Transform.scale(
          ...
          child: GestureDetector(
            ...
            child: Container(
              width: _config.getParameter('ui.voice_recorder.button_size',
                  defaultValue: 80.0),
              height: _config.getParameter('ui.voice_recorder.button_size',
                  defaultValue: 80.0),
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: (widget.isRecording
                            ...
                            : _config.getParameter('ui.colors.primary',
                                defaultValue: Colors.blue))
                        .withOpacity(_config.getParameter('ui.shadow.opacity',
                            defaultValue: 0.3)),
        ...
        Text(
          ...
          style: TextStyle(
            fontSize: _config.getParameter('ui.font.size.body_medium',
                defaultValue: 14.0),
            color: _config.getParameter('ui.colors.error',
                defaultValue: Colors.red),

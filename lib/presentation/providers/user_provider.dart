...
class UserProvider extends ChangeNotifier implements ParameterizedComponent {
  ...
  Future<void> _initializeFromConfig() async {
    ...
    _sessionTimeout = CentralConfig.instance
        .getParameter('session_timeout', Duration(hours: 24));
    _enableBiometric =
        CentralConfig.instance.getParameter('enable_biometric', true);
    _maxLoginAttempts =
        CentralConfig.instance.getParameter('max_login_attempts', 3);
    _cacheUserData =
        CentralConfig.instance.getParameter('cache_user_data', true);
  }
  ...
  Future<void> login(String email, String password,
    ...
    try {
      ...
      if (password.length <
          CentralConfig.instance.getParameter('min_password_length', 8)) {
        throw Exception(
  ...
  Future<void> register(String name, String email, String password,
    ...
    try {
      ...
      if (name.length >
          CentralConfig.instance.getParameter('max_username_length', 50)) {
      ...
      if (password.length >
          CentralConfig.instance.getParameter('max_password_length', 128)) {

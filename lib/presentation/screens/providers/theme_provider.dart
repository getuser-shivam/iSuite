...
class ThemeProvider extends BaseProvider implements ParameterizedComponent {
  ...
  Future<void> _initializeFromConfig() async {
    ...
    _parameters['primary_color'] = CentralConfig.instance.getParameter('ui.primary_color', 0xFF2196F3);
    _parameters['secondary_color'] = CentralConfig.instance.getParameter('ui.secondary_color', 0xFF03DAC6);
    _parameters['font_size'] = CentralConfig.instance.getParameter('ui.font_size_medium', 14.0);
    ...
    for (final entry in parameters.entries) {
      switch (entry.key) {
        ...
        case 'ui.primary_color':
          _parameters['primary_color'] = entry.value as int;
          break;
        case 'secondary_color':
        case 'ui.secondary_color':
          _parameters['secondary_color'] = entry.value as int;
          break;
        case 'font_size':
        case 'ui.font_size_medium':
  ...
  Map<String, dynamic> getConfigurationParameters() {
    return {
      ...
      'ui.primary_color': _parameters['primary_color'],
      'ui.secondary_color': _parameters['secondary_color'],
      'ui.font_size_medium': _parameters['font_size'],
  ...
  ThemeData buildLightTheme() {
    if (_useCustomTheme && _customTheme != null) {
      return _customTheme!.toLightTheme();
    }
    
    return ThemeData(
      useMaterial3: true,
      colorScheme: ColorScheme.fromSeed(
        seedColor: Color(_parameters['primary_color'] as int),
        secondary: Color(_parameters['secondary_color'] as int),
      ),
      textTheme: TextTheme(
        bodyLarge: TextStyle(
          fontSize: _parameters['font_size'] as double,
          fontFamily: _parameters['font_family'] as String,
        ),
  ...
  ThemeData buildDarkTheme() {
    if (_useCustomTheme && _customTheme != null) {
      return _customTheme!.toDarkTheme();
    }

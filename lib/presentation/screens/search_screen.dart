...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Widget _buildSearchBar() => Consumer<SearchProvider>(
  ...
  Widget _buildFilters() => Consumer<SearchProvider>(
        builder: (context, searchProvider, child) {
                ...
                children: [
                  ...
                  ...SearchResultType.values.map((type) {
                    ...
                    return Padding(
                      ...
                      child: FilterChip(
                        ...
                        onSelected: (selected) {
                          final newTypes =
                              List<SearchResultType>.from(filter.types);
                          if (selected) {
                            newTypes.add(type);
                          } else {
                          ...
                          searchProvider
                              .updateFilter(filter.copyWith(types: newTypes));
                        },
                      ),
                    );
                  }),
                  ...
                  DropdownButton<SearchSortBy>(
                    ...
                    onChanged: (sortBy) {
                      if (sortBy != null) {
                        searchProvider
                            .updateFilter(filter.copyWith(sortBy: sortBy));
                      }
                    },
                  ),
                  ...
                  IconButton(
                    onPressed: () {
                      searchProvider.updateFilter(filter.copyWith(
  ...
  Widget _buildEmptyState(SearchProvider searchProvider) => Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(

...
class _AnalyticsScreenState extends State<AnalyticsScreen> {
  ...
  Widget _buildTasksSection(AnalyticsProvider provider) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text(
        ...
        const SizedBox(height: 16),
        _buildChartPlaceholder('Task Status Distribution', provider.taskStatusDistribution),
        const SizedBox(height: 16),
        _buildChartPlaceholder('Task Priority Distribution', provider.taskPriorityDistribution),
      ],
    );
  }

  Widget _buildNotesSection(AnalyticsProvider provider) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text(
        ...
        const SizedBox(height: 16),
        _buildChartPlaceholder('Note Type Distribution', provider.noteTypeDistribution),
        const SizedBox(height: 16),
        _buildChartPlaceholder('Note Status Distribution', provider.noteStatusDistribution),
      ],
    );
  }

  Widget _buildFilesSection(AnalyticsProvider provider) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text(
        ...
        const SizedBox(height: 16),
        _buildChartPlaceholder('File Type Distribution', provider.fileTypeDistribution),
      ],
    );
  }

  Widget _buildEventsSection(AnalyticsProvider provider) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text(
        ...
        const SizedBox(height: 16),
        _buildChartPlaceholder('Event Type Distribution', provider.eventTypeDistribution),
      ],
    );
  }

  Widget _buildTrendsSection(AnalyticsProvider provider) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text(
        ...
        const SizedBox(height: 16),
        _buildChartPlaceholder('Task Completion Trend (Last 30 Days)', provider.taskCompletionTrend),
        const SizedBox(height: 16),
        _buildChartPlaceholder('Note Creation Trend (Last 30 Days)', provider.noteCreationTrend),
        const SizedBox(height: 16),
        _buildChartPlaceholder('File Upload Trend (Last 30 Days)', provider.fileUploadTrend),
        const SizedBox(height: 16),
        _buildChartPlaceholder('Event Creation Trend (Last 30 Days)', provider.eventCreationTrend),
      ],
    );
  }
  ...
  Widget _buildChartPlaceholder(String title, List<dynamic> data) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: Theme.of(context).cardColor,
          ...
          actions: [
            ...
            TextButton(
              onPressed: () {
                ...
                AppUtils.showSuccessSnackBar(context, 'Analytics data copied to clipboard');

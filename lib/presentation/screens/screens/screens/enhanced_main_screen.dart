...
class _EnhancedMainScreenState extends State<EnhancedMainScreen> {
  ...
  Future<void> _applyUserPreferences() async {
    try {
      ...
      final darkMode =
          _config.getParameter('ui.dark_mode', defaultValue: false);
      final compactMode =
          _config.getParameter('ui.compact_mode', defaultValue: false);
  ...
  Widget _buildQuickActionCard({
    ...
    return EnhancedUIComponents.buildCard(
      child: InkWell(
        onTap: onTap,
        borderRadius:
            BorderRadius.circular(_uiConfig.getDouble('ui.border_radius')),
        child: Column(
  ...
  Widget _buildStatusItem({
    ...
    return Padding(
      padding:
          EdgeInsets.symmetric(vertical: _uiConfig.getDouble('ui.padding') / 2),
      child: Row(

  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      shape: RoundedRectangleBorder(
        ...
        side: BorderSide(
          color: file.status == FileStatus.failed ? Colors.red.withOpacity(0.3) : Colors.transparent,
          width: 1,
        ),
      ),
      child: Padding(
            ...
            Row(
              ...
              children: [
                ...
                IconButton(
                  ...
                  tooltip: file.tags.contains('favorite') ? 'Remove from favorites' : 'Add to favorites',
